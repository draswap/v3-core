...
interface TestDraswapV3RouterInterface extends ethers.utils.Interface {
  functions: {
...
export class TestDraswapV3Router extends Contract {
  ...
  interface: TestDraswapV3RouterInterface;
