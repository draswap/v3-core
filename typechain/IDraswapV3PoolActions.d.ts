...
interface IDraswapV3PoolActionsInterface extends ethers.utils.Interface {
  functions: {
...
export class IDraswapV3PoolActions extends Contract {
  ...
  interface: IDraswapV3PoolActionsInterface;
