...
interface IDraswapV3PoolDerivedStateInterface extends ethers.utils.Interface {
  functions: {
...
export class IDraswapV3PoolDerivedState extends Contract {
  ...
  interface: IDraswapV3PoolDerivedStateInterface;
