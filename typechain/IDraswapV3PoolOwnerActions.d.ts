...
interface IDraswapV3PoolOwnerActionsInterface extends ethers.utils.Interface {
  functions: {
...
export class IDraswapV3PoolOwnerActions extends Contract {
  ...
  interface: IDraswapV3PoolOwnerActionsInterface;
