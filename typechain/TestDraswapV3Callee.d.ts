...
interface TestDraswapV3CalleeInterface extends ethers.utils.Interface {
  functions: {
...
export class TestDraswapV3Callee extends Contract {
  ...
  interface: TestDraswapV3CalleeInterface;
