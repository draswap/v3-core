...
interface MockTimeDraswapV3PoolInterface extends ethers.utils.Interface {
  functions: {
...
export class MockTimeDraswapV3Pool extends Contract {
  ...
  interface: MockTimeDraswapV3PoolInterface;
