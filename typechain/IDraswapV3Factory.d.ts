...
interface IDraswapV3FactoryInterface extends ethers.utils.Interface {
  functions: {
...
export class IDraswapV3Factory extends Contract {
  ...
  interface: IDraswapV3FactoryInterface;
