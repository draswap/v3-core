...
import type { DraswapV3PoolDeployer } from "../DraswapV3PoolDeployer";

export class DraswapV3PoolDeployer__factory extends ContractFactory {
  constructor(signer?: Signer) {
    super(_abi, _bytecode, signer);
  }

  deploy(overrides?: Overrides): Promise<DraswapV3PoolDeployer> {
    return super.deploy(overrides || {}) as Promise<DraswapV3PoolDeployer>;
  }
  getDeployTransaction(overrides?: Overrides): TransactionRequest {
    return super.getDeployTransaction(overrides || {});
  }
  attach(address: string): DraswapV3PoolDeployer {
    return super.attach(address) as DraswapV3PoolDeployer;
  }
  connect(signer: Signer): DraswapV3PoolDeployer__factory {
    return super.connect(signer) as DraswapV3PoolDeployer__factory;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): DraswapV3PoolDeployer {
    return new Contract(
      address,
      _abi,
      signerOrProvider
    ) as DraswapV3PoolDeployer;
  }
}
