...
interface IDraswapV3PoolImmutablesInterface extends ethers.utils.Interface {
  functions: {
...
export class IDraswapV3PoolImmutables extends Contract {
  ...
  interface: IDraswapV3PoolImmutablesInterface;
