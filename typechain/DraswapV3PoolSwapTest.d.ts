...
interface DraswapV3PoolSwapTestInterface extends ethers.utils.Interface {
  functions: {
...
export class DraswapV3PoolSwapTest extends Contract {
  ...
  interface: DraswapV3PoolSwapTestInterface;
