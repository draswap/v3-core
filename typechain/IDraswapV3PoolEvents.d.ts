...
interface IDraswapV3PoolEventsInterface extends ethers.utils.Interface {
  functions: {};
...
export class IDraswapV3PoolEvents extends Contract {
  ...
  interface: IDraswapV3PoolEventsInterface;
