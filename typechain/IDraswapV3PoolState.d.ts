...
interface IDraswapV3PoolStateInterface extends ethers.utils.Interface {
  functions: {
...
export class IDraswapV3PoolState extends Contract {
  ...
  interface: IDraswapV3PoolStateInterface;
