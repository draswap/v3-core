...
import { DraswapV3PoolSwapTest } from '../typechain/DraswapV3PoolSwapTest'
...
describe('DraswapV3Pool arbitrage tests', () => {
      ...
      for (const passiveLiquidity of [
        ...
        describe(`passive liquidity of ${formatTokenAmount(passiveLiquidity)}`, () => {
          const arbTestFixture = async ([wallet, arbitrageur]: Wallet[]) => {
            ...
            const testerFactory = await ethers.getContractFactory('DraswapV3PoolSwapTest')
            const tester = (await testerFactory.deploy()) as DraswapV3PoolSwapTest
          ...
          let tester: DraswapV3PoolSwapTest
