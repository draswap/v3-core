...
describe('DraswapV3Pool', () => {
  ...
  let pool0: MockTimeDraswapV3Pool
  let pool1: MockTimeDraswapV3Pool
  ...
  let swapTargetCallee: TestDraswapV3Callee
  let swapTargetRouter: TestDraswapV3Router
  ...
  beforeEach('deploy first fixture', async () => {
    ...
    ): Promise<[MockTimeDraswapV3Pool, any]> => {
